# Generated by Django 6.0.1 on 2026-01-25 13:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("tax_code", models.CharField(blank=True, max_length=6, null=True)),
                ("imf_code", models.CharField(blank=True, max_length=6, null=True)),
                ("tax_code_verified", models.JSONField(default=list)),
                ("activation_code_verified", models.JSONField(default=list)),
                ("imf_code_verified", models.JSONField(default=list)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
                    "account",
                    models.OneToOneField(
